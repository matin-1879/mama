...
\x1b[31;1m .----------------.   .----------------.   
\x1b[31;1m| .--------------. | | .--------------. |  
\x1b[31;1m| |  _________   | | | |   ______     | |  
\x1b[31;1m| | |_   ___  |  | | | |  |_   _ \    | |  
\x1b[31;1m| |   | |_  \_|  | | | |    | |_) |   | |  
\x1b[31;1m| |   |  _|      | | | |    |  __'.   | |  
\x1b[31;1m| |  _| |_       | | | |   _| |__) |  | |  
\x1b[31;1m| | |_____|      | | | |  |_______/   | |  
\x1b[31;1m| |              | | | |              | |  
\x1b[31;1m| '--------------' | | '--------------' |  
\x1b[31;1m '----------------'   '----------------'   
\033[92m
...
loop = 'true'
while loop == 'true':
    username = raw_input('\x1b[1;97m\xe2\x9e\xa3 ENTER USERNAME: ')
    if username == CorrectUsername:
        password = raw_input('\x1b[1;97m\xe2\x9e\xa3 ENTER PASSWORD: ')
        if password == CorrectPassword:
            print '\x1b[1;92m[\xe2\x9c\x93] Tawaw Daxl Tool BuY' + username
            time.sleep(0.5)
            loop = 'false'
        else:
            print 'Pass Halaya'
...
def menu():
    os.system('clear')
    print logo
    print '\033[92m   [1]KERKUK'
    print '\033[92m   [2]ERBIL'
    print '\033[92m   [3]SLEMANI'
    print '\033[92m   [4]KURDISTAN'
    print '\033[92m   [5]\x1b[1;97m  FREE MOD \033[92m[No CP]'
    print '\x1b[31;1m[0]  EXIT PROGRAM           '
    print '\x1b[31;1m<MATIN>'
    action()
...
def action():
    global cpb
    global oks
    peak = raw_input('\n\x1b[1;97mYAKEKYAN HALZHERA : \x1b[1;97m')
    if peak == '':
        ...
        try:
            c = raw_input('\x1b[1;97mCODE HALBZHERA : ')
            k = '+964'
            idlist = '.txt'
    ...
    time.sleep(0.5)
    psb('[\xe2\x9c\x93] Hackrdnaka Dasti Pekrd')
    time.sleep(0.5)
    psb('[\xe2\x9c\x93]  BOSTA.......')
    time.sleep(0.5)
